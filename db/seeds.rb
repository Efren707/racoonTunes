...
song3 = Song.create!({song_name: 'The Hills', genre: "R&B & Soul", description: "There is an old saying that goes “the hills have eyes”. What that basically means is that someone is always watching. And this is especially true when it comes to the lives of celebrities like The Weeknd.", author_id: demouser.id})
...
song5 = Song.create!({song_name: 'WUSYANAME', genre: "Hip-Hop & Rap", description: "A love song in which Tyler, The Creator flaunts his ability and willingness to edify a romantic interest financially.", author_id: demouser.id})
...
song7 = Song.create!({song_name: 'Believe What I Say', genre: "Hip-Hop & Rap", description: "The lyrics seemingly talk about a relationship, or rather the fall of it", author_id: demouser.id})
...
song9 = Song.create!({song_name: 'Self Care', genre: "R&B & Soul", description: "Illustrates Miller’s rollercoaster of feelings of not only towards himself but others too", author_id: demouser.id})
